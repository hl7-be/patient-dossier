...
// Note: the "RecordedDate" CareSet element is covered by the be-core extension
// BeExtRecordedDate (be-ext-recorded-date) as of be-core 2.2.0, so no local
// extension is defined here either - the profiles reference the be-core one.
